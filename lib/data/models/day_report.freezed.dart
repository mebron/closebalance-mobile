...
@useResult
$Res call({
 String date,@JsonKey(name: 'total_sales') double totalSales,@JsonKey(name: 'cash_in_hand') double cashInHand,@JsonKey(name: 'draft_closings') int draftClosings,@JsonKey(name: 'finalized_closings') int finalizedClosings,@JsonKey(name: 'total_expenses') double totalExpenses,@JsonKey(name: 'total_deductions') double totalDeductions,@JsonKey(name: 'net_profit') double netProfit,@JsonKey(name: 'cash_collections') double cashCollections,@JsonKey(name: 'cash_expenses') double cashExpenses,@JsonKey(name: 'cash_deductions') double cashDeductions,@JsonKey(name: 'total_counter_paid') double totalCounterPaid, List<ChannelSaleTotal> channels, List<ExpenseCategoryTotal> expenses, List<DeductionTypeTotal> deductions, List<CounterBalanceRow> counters
});
...
/// Create a copy of DayReport
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? date = null,Object? totalSales = null,Object? cashInHand = null,Object? draftClosings = null,Object? finalizedClosings = null,Object? totalExpenses = null,Object? totalDeductions = null,Object? netProfit = null,Object? cashCollections = null,Object? cashExpenses = null,Object? cashDeductions = null,Object? totalCounterPaid = null,Object? channels = null,Object? expenses = null,Object? deductions = null,Object? counters = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String date, @JsonKey(name: 'total_sales')  double totalSales, @JsonKey(name: 'cash_in_hand')  double cashInHand, @JsonKey(name: 'draft_closings')  int draftClosings, @JsonKey(name: 'finalized_closings')  int finalizedClosings, @JsonKey(name: 'total_expenses')  double totalExpenses, @JsonKey(name: 'total_deductions')  double totalDeductions, @JsonKey(name: 'net_profit')  double netProfit, @JsonKey(name: 'cash_collections')  double cashCollections, @JsonKey(name: 'cash_expenses')  double cashExpenses, @JsonKey(name: 'cash_deductions')  double cashDeductions, @JsonKey(name: 'total_counter_paid')  double totalCounterPaid,  List<ChannelSaleTotal> channels,  List<ExpenseCategoryTotal> expenses,  List<DeductionTypeTotal> deductions,  List<CounterBalanceRow> counters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DayReport() when $default != null:
return $default(_that.date,_that.totalSales,_that.cashInHand,_that.draftClosings,_that.finalizedClosings,_that.totalExpenses,_that.totalDeductions,_that.netProfit,_that.cashCollections,_that.cashExpenses,_that.cashDeductions,_that.totalCounterPaid,_that.channels,_that.expenses,_that.deductions,_that.counters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String date, @JsonKey(name: 'total_sales')  double totalSales, @JsonKey(name: 'cash_in_hand')  double cashInHand, @JsonKey(name: 'draft_closings')  int draftClosings, @JsonKey(name: 'finalized_closings')  int finalizedClosings, @JsonKey(name: 'total_expenses')  double totalExpenses, @JsonKey(name: 'total_deductions')  double totalDeductions, @JsonKey(name: 'net_profit')  double netProfit, @JsonKey(name: 'cash_collections')  double cashCollections, @JsonKey(name: 'cash_expenses')  double cashExpenses, @JsonKey(name: 'cash_deductions')  double cashDeductions, @JsonKey(name: 'total_counter_paid')  double totalCounterPaid,  List<ChannelSaleTotal> channels,  List<ExpenseCategoryTotal> expenses,  List<DeductionTypeTotal> deductions,  List<CounterBalanceRow> counters)  $default,) {final _that = this;
switch (_that) {
case _DayReport():
return $default(_that.date,_that.totalSales,_that.cashInHand,_that.draftClosings,_that.finalizedClosings,_that.totalExpenses,_that.totalDeductions,_that.netProfit,_that.cashCollections,_that.cashExpenses,_that.cashDeductions,_that.totalCounterPaid,_that.channels,_that.expenses,_that.deductions,_that.counters);case _:
  throw StateError('Unexpected subclass');
...
/// Create a copy of DayReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? totalSales = null,Object? cashInHand = null,Object? draftClosings = null,Object? finalizedClosings = null,Object? totalExpenses = null,Object? totalDeductions = null,Object? netProfit = null,Object? cashCollections = null,Object? cashExpenses = null,Object? cashDeductions = null,Object? totalCounterPaid = null,Object? channels = null,Object? expenses = null,Object? deductions = null,Object? counters = null,}) {
