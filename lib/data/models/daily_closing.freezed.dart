...
/// Create a copy of DailyClosing
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? date = null,Object? status = null,Object? notes = freezed,Object? branch = freezed,Object? totalSales = null,Object? totalExpenses = null,Object? totalDeductions = null,Object? cashCollections = null,Object? onlineCollections = null,Object? aggregatorCollections = null,Object? totalCounterPaid = null,Object? cashInHand = null,Object? netProfit = null,Object? sales = null,Object? expenses = null,Object? deductions = null,Object? counterTransactions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String date, @JsonKey(fromJson: _statusFromJson, toJson: _statusToJson)  ClosingStatus status,  String? notes,  Branch? branch, @JsonKey(name: 'total_sales')  double totalSales, @JsonKey(name: 'total_expenses')  double totalExpenses, @JsonKey(name: 'total_deductions')  double totalDeductions, @JsonKey(name: 'cash_collections')  double cashCollections, @JsonKey(name: 'online_collections')  double onlineCollections, @JsonKey(name: 'aggregator_collections')  double aggregatorCollections, @JsonKey(name: 'total_counter_paid')  double totalCounterPaid, @JsonKey(name: 'cash_in_hand')  double cashInHand, @JsonKey(name: 'net_balance')  double netProfit,  List<SaleLine> sales,  List<ExpenseLine> expenses,  List<Deduction> deductions, @JsonKey(name: 'counter_transactions')  List<CounterTransaction> counterTransactions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DailyClosing() when $default != null:
return $default(_that.id,_that.date,_that.status,_that.notes,_that.branch,_that.totalSales,_that.totalExpenses,_that.totalDeductions,_that.cashCollections,_that.onlineCollections,_that.aggregatorCollections,_that.totalCounterPaid,_that.cashInHand,_that.netProfit,_that.sales,_that.expenses,_that.deductions,_that.counterTransactions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String date, @JsonKey(fromJson: _statusFromJson, toJson: _statusToJson)  ClosingStatus status,  String? notes,  Branch? branch, @JsonKey(name: 'total_sales')  double totalSales, @JsonKey(name: 'total_expenses')  double totalExpenses, @JsonKey(name: 'total_deductions')  double totalDeductions, @JsonKey(name: 'cash_collections')  double cashCollections, @JsonKey(name: 'online_collections')  double onlineCollections, @JsonKey(name: 'aggregator_collections')  double aggregatorCollections, @JsonKey(name: 'total_counter_paid')  double totalCounterPaid, @JsonKey(name: 'cash_in_hand')  double cashInHand, @JsonKey(name: 'net_balance')  double netProfit,  List<SaleLine> sales,  List<ExpenseLine> expenses,  List<Deduction> deductions, @JsonKey(name: 'counter_transactions')  List<CounterTransaction> counterTransactions)  $default,) {final _that = this;
switch (_that) {
case _DailyClosing():
return $default(_that.id,_that.date,_that.status,_that.notes,_that.branch,_that.totalSales,_that.totalExpenses,_that.totalDeductions,_that.cashCollections,_that.onlineCollections,_that.aggregatorCollections,_that.totalCounterPaid,_that.cashInHand,_that.netProfit,_that.sales,_that.expenses,_that.deductions,_that.counterTransactions);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DailyClosing&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.status, status) || other.status == status)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.branch, branch) || other.branch == branch)&&(identical(other.totalSales, totalSales) || other.totalSales == totalSales)&&(identical(other.totalExpenses, totalExpenses) || other.totalExpenses == totalExpenses)&&(identical(other.totalDeductions, totalDeductions) || other.totalDeductions == totalDeductions)&&(identical(other.cashCollections, cashCollections) || other.cashCollections == cashCollections)&&(identical(other.onlineCollections, onlineCollections) || other.onlineCollections == onlineCollections)&&(identical(other.aggregatorCollections, aggregatorCollections) || other.aggregatorCollections == aggregatorCollections)&&(identical(other.totalCounterPaid, totalCounterPaid) || other.totalCounterPaid == totalCounterPaid)&&(identical(other.cashInHand, cashInHand) || other.cashInHand == cashInHand)&&(identical(other.netProfit, netProfit) || other.netProfit == netProfit)&&const DeepCollectionEquality().equals(other._sales, _sales)&&const DeepCollectionEquality().equals(other._expenses, _expenses)&&const DeepCollectionEquality().equals(other._deductions, _deductions)&&const DeepCollectionEquality().equals(other._counterTransactions, _counterTransactions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,date,status,notes,branch,totalSales,totalExpenses,totalDeductions,cashCollections,onlineCollections,aggregatorCollections,totalCounterPaid,cashInHand,netProfit,const DeepCollectionEquality().hash(_sales),const DeepCollectionEquality().hash(_expenses),const DeepCollectionEquality().hash(_deductions),const DeepCollectionEquality().hash(_counterTransactions));
...
/// Create a copy of DailyClosing
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? date = null,Object? status = null,Object? notes = freezed,Object? branch = freezed,Object? totalSales = null,Object? totalExpenses = null,Object? totalDeductions = null,Object? cashCollections = null,Object? onlineCollections = null,Object? aggregatorCollections = null,Object? totalCounterPaid = null,Object? cashInHand = null,Object? netProfit = null,Object? sales = null,Object? expenses = null,Object? deductions = null,Object? counterTransactions = null,}) {
