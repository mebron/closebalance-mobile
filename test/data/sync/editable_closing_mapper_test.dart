...
void main() {
  test('fromDailyClosing produces a clean editable doc with server ids', () {
    final dc = DailyClosing.fromJson({
      ...
      'expenses': [{'id': 6, 'expense_category_id': 7, 'category': {'id': 7, 'name': 'Rent'}, 'description': 'Rent', 'amount': 300.0, 'payment_method': 'cash', 'remarks': null}],
      'deductions': [{'id': 7, 'type': 'incentive', 'description': 'x', 'amount': 100.0, 'payment_method': 'cash'}],
